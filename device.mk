...
PRODUCT_COPY_FILES += \
    ...
    $(DEVICE_PATH)/audio/mixer_paths_matisse.xml:system/etc/mixer_paths_matisse.xml \
    $(DEVICE_PATH)/audio/mixer_paths_millet.xml:system/etc/mixer_paths_millet.xml
...
# Unified Stuff
PRODUCT_COPY_FILES += \
    $(DEVICE_PATH)/unified/boot_matisse3g.img:install/unified/boot_matisse3g.img \
    $(DEVICE_PATH)/unified/boot_matisselte.img:install/unified/boot_matisselte.img \
    $(DEVICE_PATH)/unified/boot_matissewifi.img:install/unified/boot_matissewifi.img \
    $(DEVICE_PATH)/unified/boot_millet3g.img:install/unified/boot_millet3g.img \
    $(DEVICE_PATH)/unified/boot_milletlte.img:install/unified/boot_milletlte.img \
    $(DEVICE_PATH)/unified/boot_milletwifi.img:install/unified/boot_milletwifi.img \
